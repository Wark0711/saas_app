...
export async function ViewsByDayChart({ chartData }: {
    chartData: {
        date: string,
        views: number
    }[]
    ...
    if (chartData.length == 0) {
        return (
            <p className="flex items-center justify-center text-muted-foreground min-h-[150px] max-h-[250px]">No data available</p>
        )
    }
