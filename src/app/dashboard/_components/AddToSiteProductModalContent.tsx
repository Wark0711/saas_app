...
import { env } from "@/data/env/clients"
    ...
    return (
        <DialogContent className="max-w-max">
            <DialogHeader>
                ...
                <DialogDescription>All you need to do is copy the below scrpit into your site and your customers will start seeing PPP discounts!</DialogDescription>
            </DialogHeader>
