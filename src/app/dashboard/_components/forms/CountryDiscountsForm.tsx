...
export function CountryDiscountsForm({ productId, countryGroups }: {
    ...
    async function onSubmit(values: z.infer<typeof productCountryDiscountSchema>) {
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input className="w-48" type="number" {...field} value={field.value ?? ""} onChange={e => field.onChange(e.target.valueAsNumber)} min={0} max={100} />
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                            )}
