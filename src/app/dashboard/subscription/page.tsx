            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            {formatCompactNumber(pricingViewCount)} / {formatCompactNumber(tier.maxNumberOfVisits)} pricing per page
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            {formatCompactNumber(productCount)} / {formatCompactNumber(tier.maxNumberOfProducts)} products created
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
