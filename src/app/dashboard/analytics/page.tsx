...
async function ProductDropdown({ userId, selectedProductId, searchParams }: {
    userId: string,
    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent>
                <DropdownMenuItem asChild>
                    <Link href={createURL('/dashboard/analytics', searchParams, { productId: undefined })}>All Products</Link>
                </DropdownMenuItem>
                {
