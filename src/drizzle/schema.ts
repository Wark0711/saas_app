...
export const ProductCustomizationTable = pgTable('product_customizations', {
    ...
    locationMessage: text('location_message').notNull().default("Hey! It looks that you are from <b>{country}</b>. We support Parity Purchasing Power, so if you need it, use code <b>{coupon}</b> to get <b>{discount}%</b> off."),
