...
CREATE TABLE IF NOT EXISTS "product_customizations" (
	...
	"class_prefix" text,
	"product_id" uuid NOT NULL,
	"location_message" text DEFAULT 'Hey! It looks that you are from <b>{country}</b>. We support Parity Purchasing Power, so if you need it, use code <b>{coupon}</b> to get <b>{discount}%</b> off.' NOT NULL,
